...
class Args:
    ...
    # PPO Continuous defaults to Pendulum
...
class Agent(nn.Module):
    def __init__(self, envs):
        ...
        # THEORY - Action Standard Deviations (wiki/PPO-Continuous.md)
    ...
    def get_action_and_value(self, x, action=None):
        ...
        # 1. Create a Gaussian Distribution curve around the predicted mean, with the trainable standard deviation
        probs = Normal(action_mean, action_std)
        if action is None:
            action = probs.sample()
        # 2. Return the Action, LogProbability, Entropy, and State Value
...
if __name__ == "__main__":
    ...
    progress_bar = tqdm.tqdm(range(1, num_iterations + 1), desc="PPO Continuous Training")
