...
class Agent(nn.Module):
    ...
    def get_action_and_value(self, x, action=None):
        ...
        # Scale action from [0, 1] to environment space [-1, 1] for steering, [0, 1] for gas/brake
        # Gymnasium CarRacing actions: [steering, gas, brake]
        # steering: [-1, 1], gas: [0, 1], brake: [0, 1]
        # Note: Rafael1s uses Beta distribution which is naturally [0, 1].
        # We transform the sampled action during env.step() or here.
